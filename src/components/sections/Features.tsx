...
export function Features() {
  ...
  return (
    <div id="features" ref={sectionRef} className="scroll-mt-16">
      ...
      <section className="relative py-20 sm:py-24 section-divider flex flex-col justify-center overflow-hidden">
        {/* Subtle background glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-trade-red/5 blur-[130px] rounded-full pointer-events-none"></div>

        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal w-full relative z-10">
          <p className="text-brand-gold text-sm font-bold uppercase tracking-widest mb-3">Sound Familiar?</p>
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto stagger-children">
            <div className="card-glow bg-dark-surface border border-dark-border rounded-xl p-5 space-y-3 shadow-lg">
      ...
      <section className="relative py-20 sm:py-24 section-divider flex flex-col justify-center overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] bg-brand-gold/5 blur-[140px] rounded-full pointer-events-none"></div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          ...
          <div className="grid sm:grid-cols-2 gap-6 stagger-children">
            {/* Pre-Trade Gate */}
            <div className="card-glow bg-dark-surface border border-dark-border rounded-2xl p-6 sm:p-8 space-y-4 shadow-xl">
